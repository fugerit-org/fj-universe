    ...
    public void generate() throws IOException {
        try (StringWriter buffer = new StringWriter();
            ...
            for (SectionModel section : SectionCatalog.getSectionsFugeritOrg()) {
                ...
                writer.println();
                writer.println("| pom property | repository | repo central | quality gate | test coverage |");
                writer.println("|--------------|------------|--------------|--------------|---------------|");
                for (String module : section.getItems()) {
                    ...
                    writer.println(MessageFormat.format(
                            "| [{1}-version](src/docs/versions-" + name
                                    + ".md#{1}-version) | [fugerit-org/{0}](https://github.com/fugerit-org/{0}) | "
